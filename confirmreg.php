...
if(isset($_GET['code']))
{
   ...
   {
        $couzoo->RedirectToURL("thank-you-regd.html");
   }
}
...
<!-- Form Code Start -->
<div id='member'>
<form id='confirm' action='<?php echo $aronedesigns->GetSelfScript(); ?>' method='get' accept-charset='UTF-8'>
<div class='short_explanation'>* required fields</div>
<div><span class='error'><?php echo $aronedesigns->GetErrorMessage(); ?></span></div>
<div class='container'>

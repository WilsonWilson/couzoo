...
<!--Start Confirm text-->
<div class="m-use-confirm-text">
<span>WAIT!</span> Do not press "yes, use now" until the merchant has viewed and approved the use of this coupon.
</div>
<!--END Confirm text-->


<div class="are-you-sure">Are you sure you want to use this coupon now?</div>


<div class="m-use-now-push-yes"></div>
</div><!--End Container-->

<div class="m-use-now-button-contianer-yes">
	<div class="m-use-now-button-yes">
       <a href="m-used-done.php?id=<?=$c['id_coupon']?>"> <div class="use-this-coupon">yes, use now</div></a>
    </div>
<br clear="all"/>
	<div class="m-use-now-button-no">
       <a href="m-my-coupons.php"> <div class="use-this-coupon">no, not now</div></a>
    </div>

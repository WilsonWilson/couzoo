...
<div class="m-nav-header">
    ...
    <div class="m-use-page-title">Coupon Purchased</div>
...
<div class="are-you-sure">Thanks for your purchase. Would you like to use this coupon now?</div>
...
<div class="m-use-now-button-contianer-yes">
	<div class="m-use-now-button-yes">
       <a href="m-use-confirm.php?id=<?=$c['id_coupon']?>"> <div class="use-this-coupon">yes, use now</div></a>
    </div>
<br clear="all"/>
	<div class="m-use-now-button-no">
       <a href="m-my-coupons.php"> <div class="use-this-coupon">no, go home</div></a>
    </div>

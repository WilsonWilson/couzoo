...
/*Below is for mobile home */
        $(document).ready(function () {
            /*Calling your own functions through Form Highlighter*/
            $("#m-advancedCall").formHighlighter({
                classFocus: 'demoFocus',
                classBlur: 'demoBlur',
                classKeyDown: 'demoKeydown',
                classNotEqualToDefault: 'demoNotEqualToDefault',
            ...
            /*Your own function that will be called from Form Highlighter*/
            function demoBlur() {
                $("#m-advancedCall input.demoBlur:not(input:hidden)").stop(0, 1).fadeTo(500, 2.0);
            }
            function demoFocus(element) {
                $("#m-advancedCall input.demoBlur:not(input:hidden)").stop(0, 1).fadeTo(400, 0.5);
            }
        });
		
/*Below is for mobile change location*/
        $(document).ready(function () {
            /*Calling your own functions through Form Highlighter*/
            $("#m-advancedCall2").formHighlighter({
                classFocus: 'demoFocus',
                classBlur: 'demoBlur',
                classKeyDown: 'demoKeydown',
                classNotEqualToDefault: 'demoNotEqualToDefault',
            ...
            /*Your own function that will be called from Form Highlighter*/
            function demoBlur() {
                $("#m-advancedCall2 input.demoBlur:not(input:hidden)").stop(0, 1).fadeTo(500, 2.0);
            }
            function demoFocus(element) {
                $("#m-advancedCall2 input.demoBlur:not(input:hidden)").stop(0, 1).fadeTo(400, 0.5);
            }
        });
...
/*Below is for mobile change location*/
        $(document).ready(function () {
            /*Calling your own functions through Form Highlighter*/
            $("#m-advancedCall3").formHighlighter({
                classFocus: 'demoFocus',
                classBlur: 'demoBlur',
                classKeyDown: 'demoKeydown',
                classNotEqualToDefault: 'demoNotEqualToDefault',
            ...
            /*Your own function that will be called from Form Highlighter*/
            function demoBlur() {
                $("#m-advancedCall3 input.demoBlur:not(input:hidden)").stop(0, 1).fadeTo(500, 2.0);
            }
            function demoFocus(element) {
                $("#m-advancedCall3 input.demoBlur:not(input:hidden)").stop(0, 1).fadeTo(400, 0.5);
            }
        });
...
/*Below is for mobile change location*/
        $(document).ready(function () {
            /*Calling your own functions through Form Highlighter*/
            $("#m-advancedCall4").formHighlighter({
                classFocus: 'demoFocus',
                classBlur: 'demoBlur',
                classKeyDown: 'demoKeydown',
                classNotEqualToDefault: 'demoNotEqualToDefault',
            ...
            /*Your own function that will be called from Form Highlighter*/
            function demoBlur() {
                $("#m-advancedCall4 input.demoBlur:not(input:hidden)").stop(0, 1).fadeTo(500, 2.0);
            }
            function demoFocus(element) {
                $("#m-advancedCall4 input.demoBlur:not(input:hidden)").stop(0, 1).fadeTo(400, 0.5);
            }
        });
